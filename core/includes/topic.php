...
class Topic extends DatabaseObject {
    ...
    protected static $db_fields = array('topic_id', 'topic_name','topic_subject', 'topic_date', 'topic_cat', 'topic_by');
    public $topic_id;
    public $topic_name;
    public $topic_subject;
    public $topic_date;
    public $topic_cat;
    public $topic_by;
    ...
    public static function find_by_id($id = 0) {
        $result_array = self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE topic_id={$id} LIMIT 1");
